    ...
    <section className="pt-24 pb-32">
      <div className=" container mx-auto">
        <div className=" flex flex-col xl:flex-row gap-14">
          ...
          {/*text */}
          <div className=" flex-col flex-1 flex  justify-center items-start gap-10">
            ...
            <div className="flex flex-col gap-6 items-start">
              ...
              <AddToCartBtn text="Add to cart" btnStyles="btn btn-accent" price_id={bike. price_id} price={bike.price} currency='USD' name={bike.name}  description={bike.description} />
            </div>
            {/* info */}
